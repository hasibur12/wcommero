 ...
 * @since 1.0
 */
class Wcommero_List extends Widget_Base
{

    public function get_name()
    {
        return 'wcommero-list-style';
    }

    public function get_title()
    {
        return esc_html__('List Style', 'wcommero-store-builder');
    }
    ...
    protected function register_controls()
    {
        ...
        wcommero_elementor_style_options($this, 'Content', '{{WRAPPER}} .content p', ['style-1']);
        wcommero_elementor_style_options($this, 'Icon', '{{WRAPPER}} .cart-btns i', ['style-1']);
    ...
    protected function render()
    {
        ...
        include wcommero_get_template('list-one.php');
    }
}

\Elementor\Plugin::instance()->widgets_manager->register(new Wcommero_List());
