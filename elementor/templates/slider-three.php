...
?>
    ...
    <section class="shop-section fix section-padding pt-0">
        <div class="wco-container">
            <div class="swiper shop-slider2" data-slider-settings="<?php echo esc_attr(wp_json_encode($wcommero_slider_settings)); ?>">
                ...
                <?php if (!empty($settings['enable_dots']) && $settings['enable_dots'] === 'yes') : ?>
                    <div class="swiper-dot2 text-center mt-5">
                        <div class="dot"></div>
                    </div>
                <?php endif; ?>
            </div>
